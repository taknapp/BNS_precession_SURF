...
\left(\frac{\dd \deltachi}{\dd t}\right)^2= \mathcal{A} ^2(1-\cos \theta_1)^2 (1-\cos \theta_2)^2  (1-\cos \Delta \Phi)^2 
\end{align} 
where
...
\cos\theta_{2} &=\frac{(1+q) \left[2 \sqrt{r/M} -(1+k_1) \delta \chi \right] }{{(2+k_1+k_2) \chi_2}} + \notag \\ &
-\frac{ (1+q) \sqrt{4 r/M+ (1-k_1 k_2) \delta \chi^2+(2-k_1+ k_2) \chicons^2 -2 \sqrt{r} \left[ (k_1-k_2) \delta\chi+(2+k_1+k_2)\chicons \right] }}{(2+k_1+k_2) \chi_1}.
\end{align} 
...
\begin{align}
\frac{\dd \kappa}{\dd u}&=- \frac{(1+q)^2 \left\{ 2+ q\left[ 4+2 q+  u (k_2-k_1)\deltachi - u (2+k_1+k_2) \chicons \right] \right\}}{u^2 q (2+k_1+k_2)  \left[ (1+q)^2-2 q u \chicons \right]} + \notag \\ &
